    ...
    <header className="top-0 sticky w-full min-w-[950px] z-50">
      ...
      <div className="py-3 pl-5 pr-20 flex justify-between bg-white border-b-2 border-b-slate-300 ">
        <NavLink to={"/"}>
          <img
            className="h-10"
            src="/images/logos/fu_Ex_logo.png"
            ...
            >
              <button className="flex justify-between items-center pl-5">
                <div className="flex justify-center items-center text-xl">
                  ...
                  {(user && user.sellerTO
                    ? user.sellerTO.student.firstName +
                      " " +
                      user.sellerTO.student.lastName
                    : "") ||
                    (user
                        ...
                        room?.active === true && (
                          ...
                          >
                            <div>
                              <div
                                key={room.chatRoomId}
                                className="hover:bg-gray-100 cursor-pointer duration-200 w-full"
                              >
                                <div className="flex items-center mb-4 px-2">
                                  ...
                                  {room.chatMessage &&
                                    room.chatMessage.length > 0 && (
                                      <div
                                        key={room.chatMessage[0].messageId}
                                        className="flex flex-grow items-center justify-between ml-2"
                                      >
                                        <div>
                                          <div className="text-base font-semibold">
                                            {truncateContent(
                                              room.chatMessage[0]
                                                .studentSendId === registeredId
                                                ? `${
                                                    user?.[
                                                      room.chatMessage[0]
                                                        .studentReceiveId
                                        ...
                                        <div className="text-right text-sm">
                                          ...
                                          <Popover
                                            ...
                                            content={
                                              ...
                                              >
                                                <DeleteOutlined className="text-xl mr-2" />
                                                Delete
                                              </button>
                                            }
                                            trigger="click"
            ...
            <div className="w-full h-full flex flex-col">
              <div className="flex justify-between items-center border-b-2 border-b-slate-300 py-2 px-4 text-lg text-[var(--color-primary)]">
                <div className="font-semibold">
                  {userDetail?.student?.firstName}{" "}
                  {userDetail?.student?.lastName}
                </div>
                <Popover
                  placement="bottomRight"
                  content={
              ...
              {chatDetail && !isEmptyChatDetail && (
                <div className="flex justify-between items-center border-t-2 border-t-slate-300 py-2 px-4">
                  <input
                    type="text"
                    placeholder="Gửi gì đó đi..."
                    className="w-full focus:outline-none pr-3"
                    onChange={(e) => {
                      contentRef.current = e.target.value;
                    }}
                    onKeyPress={handleKeyPress}
                  />
                  <button onClick={reloadBoxChat}>
                    <SendOutlined className="text-[var(--color-primary)]" />
                  </button>
                </div>
              )}
            </div>
